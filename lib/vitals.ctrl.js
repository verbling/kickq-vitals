 ...
 * @private
 */
VitalsCtrl.prototype._stop = function() {
  log.fine('_stop() :: Init. _isOn: ', this._isOn);
...
VitalsCtrl.prototype._onInterval = function() {
  ...
  this._startTime = Date.now();
  log.finer('_onInterval() :: Model finished. ');
...
VitalsCtrl.prototype._onRemoveListener = function(eventType, optAll) {
  log.info('_onRemoveListener() :: type, optAll, listeners:', eventType,
    optAll, this._listeners);
